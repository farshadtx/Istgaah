...
import com.radiofarda.istgah.playback.CastPlayback;
import com.radiofarda.istgah.playback.LocalPlayback;
 ...
 * <p>
 * <li> Handle all the actual music playing using any method your app prefers (for radiofarda,
 ...
 * For radiofarda, in AndroidManifest.xml:
...
public class MusicService extends MediaBrowserServiceCompat implements
    ...
    public static final String EXTRA_CONNECTED_CAST = "com.radiofarda.istgah.CAST_NAME";
    // The action of the incoming Intent indicating that it contains a command
    // to be executed (see {@link #onStartCommand})
    public static final String ACTION_CMD = "com.radiofarda.istgah.ACTION_CMD";
