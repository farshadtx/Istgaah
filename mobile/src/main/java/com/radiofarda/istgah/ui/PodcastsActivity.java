...
public class PodcastsActivity extends BaseActivity
    ...
    public static final String EXTRA_START_FULLSCREEN =
            "com.radiofarda.istgah.EXTRA_START_FULLSCREEN";
    /**
    ...
    public static final String EXTRA_CURRENT_MEDIA_DESCRIPTION =
            "com.radiofarda.istgah.CURRENT_MEDIA_DESCRIPTION";
    private static final String TAG = LogHelper.makeLogTag(PodcastsActivity.class);
    private static final String SAVED_MEDIA_ID = "com.radiofarda.istgah.MEDIA_ID";
    ...
    public void onMediaItemSelected(MediaBrowserCompat.MediaItem item) {
        ...
        if (episode.findAvailableFile() == null) {
            episode.download(getPreferredEpisodeQuality());
        }
        if (item.isPlayable()) {
