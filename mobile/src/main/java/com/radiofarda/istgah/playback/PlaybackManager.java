...
public class PlaybackManager implements Playback.Callback {
    ...
    private static final String CUSTOM_ACTION_THUMBS_UP = "com.radiofarda.istgah.THUMBS_UP";
    ...
    private class MediaSessionCallback extends MediaSessionCompat.Callback {
         ...
         * should defer the actual search to another thread (for radiofarda, by using
